...
function AddCretificate() {
  ...
  return (
    ...
    <div className="add-container">
        <h3 className="add-title">Add a New Certificate</h3>
        ...
        <div className="add-form">
          ...
          <div className="form-fields">
            <div className="input-group">
              <label htmlFor="project-name">Certificate Name</label>
              <input
                id="project-name"
                type="text"
            ...
            <div className="input-group">
              <label htmlFor="project-desc">Certificate Description</label>
              <textarea
                id="project-desc"
